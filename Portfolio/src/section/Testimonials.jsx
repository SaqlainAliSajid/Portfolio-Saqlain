...
import w1 from "../assets/w1.jfif"; // Female testimonial image 1
...
const testimonials = [
  {
    name: "Jamsheed Ali",
    role: "Founder of Reflink",
    review:
      "Saqlain is a visionary developer. His attention to detail and creativity blew us away. Our project was a massive success because of him.",
    image: m1, // Points to imported image
  },
  {
    name: "Muhammad Jawad",
    role: "CEO of Techtonics",
    review:
      "Working with Saqlain was an absolute pleasure. He brings design and code together like magic. Highly recommend him!",
    image: m2,
  },
  {
    name: "Asifa khalid",
    ...
    review:
      "From concept to execution, Saqlain handled everything flawlessly. His work ethic and innovation are unmatched.",
    image: w1,
  },
  {
    name: "Meloni Max",
    ...
    review:
      "Saqlain transformed our outdated platform into something modern and powerful. His skills are world-class.",
    image: w2,
  },
];
