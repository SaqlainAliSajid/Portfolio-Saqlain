  ...
  return(
    <section ref={sectionRef} id="skills" className="h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="rounded-full top-1/4 left-0 absolute w-75 h-75 opacity-20 blur-[120px] animate-pulse bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63]"/>
          <div className="rounded-full bottom-1/4 right-0 absolute w-75 h-75 opacity-20 blur-[120px] delay-500 animate-pulse bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63]"/>
        </div>
